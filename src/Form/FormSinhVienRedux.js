...
import { connect } from 'react-redux';
 ...
 class FormSinhVienRedux extends Component {
    ...
    handleChangeInput = (event) => {
        ...
        const newValues = { ...this.props.singVienRedux.values } //lưu lại các giá trị trc
        ...
        this.setState({
            ...
            console.log(this.props.singVienRedux)
        })

        //xử lý error
        const newErrors = { ...this.props.singVienRedux.errors }
            ...
            <form>
                <div className="card text-left ">
                    ...
                    <div className="card-footer text-muted">
                        ...
                        <button className="btn btn-primary ml-1" onClick={()=>{this.props.dispatch({
            type: 'SET_SV_REDUX',
            sinhVien: this.state.values
...
const mapstatetoprops = (state) => {
    return {
        sinhVienRedux: state.stateQuanLySinhVien.sinhVienRedux
    }
}
